...
#' Chilling Degree Day with photoperiod(CDDP) adapted from PTT
...
#' Chilling Degree Day with photoperiod(CDDPm) and soil moisture
CDDPm <- function(par, data){
  # exit the routine as some parameters are missing
  if (length(par) != 4){
    stop("model parameter(s) out of range (too many, too few)")
  }
